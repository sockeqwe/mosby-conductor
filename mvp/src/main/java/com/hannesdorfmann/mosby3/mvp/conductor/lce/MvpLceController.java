...
public abstract class MvpLceController<CV extends View, M, V extends MvpLceView<M>, P extends MvpPresenter<V>>
  ...
  protected int getContentViewId() {
    return com.hannesdorfmann.mosby3.mvp.conductor.R.id.contentView;
  }
  ...
  protected int getErrorViewId() {
    return com.hannesdorfmann.mosby3.mvp.conductor.R.id.errorView;
  }
  ...
  protected int getLoadingViewId() {
    return com.hannesdorfmann.mosby3.mvp.conductor.R.id.loadingView;
  }
